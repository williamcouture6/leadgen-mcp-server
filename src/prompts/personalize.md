...
- Format obligatoire: `"{Jour} {date} à {heure} ou {jour2} {date2} à {heure2}, un appel rapide ?"`
- Exemple valide: `"Mercredi 13 mai à 18h ou jeudi 14 mai à 18h30, un appel rapide ?"`
...
- CTA fallback générique: `"Un appel rapide cette semaine ?"` ou `"Un appel rapide dans les prochains jours ?"` — SANS proposer de jour/heure précis.
...
- **CTA explicite et facile**: jamais "qu'en pensez-vous?" mais "un appel rapide jeudi?" ou "un appel rapide cette semaine?".
